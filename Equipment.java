...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        return otherEq.getName().equals(this.getName()) && otherEq.getCount()==this.getCount() && otherEq.getTotalWeight()==this.getTotalWeight() && otherEq.getTotalPrice() == this.getTotalPrice() && otherEq.getDescription().equals(this.getDescription());
